...
\lhead{MATH 110--003--004 200730                    \\ 
       Midterm Test 1A \hspace{1.25in} Page\ \thepage\ of \pageref{LastPage} \\ 
       Time: 50 minutes                             \\
       \quad}
...
\item Find the following derivatives.
  \begin{enumerate}
  \item $u'(1)$ where $\ds u=\sqrt[5]{t} + 4\sqrt{t^5}$\marginpar{\small(4)}
\vfill
  \item $y'$ where $\ds y=\frac{r^2}{1+\sqrt{r}}$\marginpar{\small(4)}
\vfill
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% begin page 2 %%%
